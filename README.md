...
**Status:** Phases 0–2 landed (spike, conn/policy, stdio MCP + 8 catalog tools). Phase 3 in progress — `nexql-index` model/store/builder/lexical/joins; golden-file parity still TODO.
